            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse text-[11px]">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border border-slate-200 px-2 py-1 font-mono">raw.info.language_probability</td>
                    <td className="border border-slate-200 px-2 py-1">Model internals</td>
                    <td className="border border-slate-200 px-2 py-1">
                  ...
                  <tr>
                    <td className="border border-slate-200 px-2 py-1 font-mono">raw.info.duration_after_vad</td>
                  ...
                  <tr>
                    <td className="border border-slate-200 px-2 py-1 font-mono">raw.info.all_language_probs</td>
                    <td className="border border-slate-200 px-2 py-1">Model internals</td>
                    <td className="border border-slate-200 px-2 py-1">
